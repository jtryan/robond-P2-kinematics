...
def test_code(test_case):
 ...
 #ROT_EE = ROT_EE * Rot_Error
    ...
    ROT_EE = john.ROT_EE.evalf(subs = {'r': roll, 'p': pitch, 'y': yaw})

    # EE = Matrix([[px],
    #             [py],
    #             [pz]])
    
    EE = john.EE.evalf(subs = {'Px': px, 'Py': py, 'Pz': pz})
    ...
    R0_3 = john.T0_1[0:3,0:3] * john.T1_2[0:3,0:3] * john.T2_3[0:3,0:3]
    ...
    FK = john.T0_EE.evalf(subs={'q1': theta1, 'q2': theta2, 'q3': theta3, 'q4': theta4, 'q5': theta5, 'q6': theta6})
